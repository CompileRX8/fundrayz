...
//  }
  ...
  /**
    * Provides the Foursquare provider.
    *
    * @param httpLayer The HTTP layer implementation.
    * @param stateProvider The OAuth2 state provider implementation.
    * @param configuration The Play configuration.
    * @return The Foursquare provider.
    */
  @Provides
  def provideFoursquareProvider(
                                httpLayer: HTTPLayer,
                                stateProvider: OAuth2StateProvider,
                                configuration: Configuration): FoursquareProvider = {

    new FoursquareProvider(httpLayer, stateProvider, configuration.underlying.as[OAuth2Settings]("silhouette.foursquare"))
  }
  ...
  def provideLinkedInProvider(
    ...
    new LinkedInProvider(httpLayer, stateProvider, configuration.underlying.as[OAuth2Settings]("silhouette.linkedin"))
  }
